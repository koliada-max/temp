...
const Navigation = ({ open, closeMenu, navigationData }) => {
  ...
  React.useEffect(() => {
    tl.to(overlayElement, 1.2, { y: '100%', ease: Expo.easeInOut })
      ...
      .staggerTo(navLink.current, 0.8, { y: 0, opacity: 1, ease: Expo.easeInOut, delay: -0.35 }, 0.15)
  ...
  return (
    <nav className="navigation" loading="lazy" ref={(e) => (nav = e)}>
      <div className="navigation__wrapper">
        ...
        <div className="navigation__header">
          ...
          <div className="navigation__header-close">
            <button className="navigation__close navigation-close__link" onClick={closeMenu}>
        ...
        <div className="navigation__menu-wrapper">
          ...
          <div className="navigation__menu-section">
            ...
            <div className="navigation__button-container">
              <button className="navigation__button" ref={(e) => (buttonElement = e)}>
